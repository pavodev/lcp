...
class CorpusData:
    ...
    def __init__(self, path_corpus):
        ...
        self.path_data_documents = PATH_BNC_DATA_DOCUMENTS  # TODO: extract data «documents» from corpus
    ...
    def export_data_as_csv(self):
        ...
        with open(self.path_data_forms, 'w') as fo_forms, open(self.path_data_lemmata, 'w') as fo_lemmata:
            with open(self.path_data_tokens) as fi_tokens, open(self.path_data_tokens_, 'w') as fo_tokens:
                for line in fi_tokens:
                    ...
                    if lemma not in lemmata:
                        ...
                        i_lemma += 1
                    fo_tokens.write('\t'.join([d[0], str(forms[d[1]]), str(lemmata[d[2]]), d[3], d[4], d[5], d[6]]) + '\n')
